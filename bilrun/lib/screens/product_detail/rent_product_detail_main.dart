...
void main() => runApp(RentProductDetailScreen());

String NameOfProduct = '';
String DescriptionOfProduct='';

class RentProductDetailScreen extends StatefulWidget {



  @override
  _RentProductDetailScreenState createState() => _RentProductDetailScreenState();
}

class _RentProductDetailScreenState extends State<RentProductDetailScreen> {
