...
void main() => runApp(LendProductDetailScreen());

String NameOfProduct = '';

class LendProductDetailScreen extends StatefulWidget {



  @override
  _LendProductDetailScreenState createState() => _LendProductDetailScreenState();
}

class _LendProductDetailScreenState extends State<LendProductDetailScreen> {
